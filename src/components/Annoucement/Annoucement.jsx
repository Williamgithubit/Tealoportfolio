  ...
  return (
      <section className="w-full mt-20">
        <div className="heading lg:p-4 px-14 py-8">
          <h1 className="text-2xl md:text-4xl text-center font-bold mb-5 text-text-light-primary dark:text-text-dark-primary">FAQ</h1>
        </div>
        <div className="wrapper p-6 md:p-4 w-full flex flex-col sm:flex-row lg:flex-row gap-3 mt-[-1rem]">
          ...
          <div className="content w-full sm:w-[40%] px-8 p-2 bg-background-light-secondary dark:bg-background-dark-secondary hidden sm:block">
